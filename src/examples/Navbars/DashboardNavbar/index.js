...
function DashboardNavbar({ absolute, light, isMini, setSearchTerm }) {
  ...
  const [searchTermPrivate, setsearchTermPrivate] = useState(searchTerm || "");
  ...
  const handleSearch = (e) => {
    setsearchTermPrivate(e.target.value);
    if (currentRoute !== "/documents/search") {
  ...
  useEffect(() => {
    if (currentRoute === "/documents/search") {
      setSearchTerm(searchTermPrivate);
    }
  }, [searchTermPrivate]);
